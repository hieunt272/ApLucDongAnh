...
namespace ApLucDongAnh.Models
{
    public class Contact
    {
        ...
        [Display(Name = "Khu vực"), UIHint("DisplayRegion")]
        public int Region { get; set; }
        [Display(Name = "Tên Công Ty của bạn*"), Required(ErrorMessage = "Hãy nhập tên Công Ty"), UIHint("TextBox"), StringLength(150, ErrorMessage = "Tối đa 150 ký tự")]
