...
function productDetail() {
    ...
    $(".product-detail table").addClass("table table-bordered").wrap("<div class='table-responsive'>");
    $(".product-detail iframe").wrap("<div class='embed-responsive embed-responsive-16by9'>");
}
